...
impl AllocaOp {
    ...
    pub fn array_size(&self) -> Shared<OpOperand> {
...
impl ReturnOp {
    pub fn operand(&self) -> Option<Shared<OpOperand>> {
        self.operation.rd().operand(0)
    }
}
