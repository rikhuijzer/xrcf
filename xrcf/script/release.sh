...
echo ""
echo "- RUN 'cargo publish -p xrcf --dry-run --allow-dirty'"
echo ""
...
NOTES="See [CHANGELOG.md](https://github.com/rikhuijzer/xrcf/blob/main/CHANGELOG.md) for more information about changes since the last release."
